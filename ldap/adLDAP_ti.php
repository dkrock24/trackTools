...
class adLDAP {
    ...
    * @var string
    */   
	protected $_account_suffix = '@ti.ads';
    ...
    * @var string
    */
	protected $_base_dn = 'DC=ti,DC=ads'; 
    ...
    * @var array
    */
    //protected $_domain_controllers = array ("172.17.133.10");
    protected $_domain_controllers = array ("172.17.192.100");
    ...
    */
    public function connect() {
        ...
        if ($this->_use_ssl){
            $this->_conn = ldap_connect("ldaps://".$dc, 389);//636);
        } else {
