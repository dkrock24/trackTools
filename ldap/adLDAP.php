...
class adLDAP {
    ...
    * @var string
    */   
	protected $_account_suffix = '@sv.transactelgroup.com';
    ...
    * @var string
    */
	protected $_base_dn = 'DC=sv,DC=transactelgroup,DC=com'; 
    ...
    * @var array
    */
    protected $_domain_controllers = array ("172.23.200.81");
    /**
     * This is the old ip... the new ip was changed on 3/14/2012 because servers issues
     * protected $_domain_controllers = array ("172.23.200.44");
     */
    ...
    * Set the base dn
    * 
    * @param string $_base_dn
    * @return void
    */
    public function set_base_dn($_base_dn)
    {
