...
<div class="clearfix">
	...
	<div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2> Data <small>different form elements</small></h2>
                                ...
                                <div class="x_content">
                                    ...
                                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Short Name <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="form-group">
                                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Name on P.M</label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Tecnologia <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Config DB<span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="birthday" placeholder='DB Name ' class="date-picker form-control col-md-7 col-xs-12" required="required" type="text">
                                                 <input id="birthday" placeholder='DB IP' class="date-picker form-control col-md-7 col-xs-12" required="required" type="text">
                                                 <input id="birthday" placeholder='DB User' class="date-picker form-control col-md-7 col-xs-12" required="required" type="text">
                                            </div>

                                        </div>

                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Web Config<span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="birthday" placeholder='Host Name ' class="date-picker form-control col-md-7 col-xs-12" required="required" type="text">
                                                 <input id="birthday" placeholder='Host IP' class="date-picker form-control col-md-7 col-xs-12" required="required" type="text">
                                                 <input id="birthday" placeholder='Path' class="date-picker form-control col-md-7 col-xs-12" required="required" type="text">
                                                 <input id="birthday" placeholder='Link Producction' class="date-picker form-control col-md-7 col-xs-12" required="required" type="text">
                                            </div>
...
<div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form class="form-horizontal form-label-left">
                                <div class="form-group">
                                    <label class="control-label col-md-3" for="first-name">Project Name <span class="required">*</span>
                                    </label>
                                    <div class="col-md-7">
